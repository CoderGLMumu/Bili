...
- (void)viewDidLoad {
    ...
    self.contentScrollV.contentSize = CGSizeMake(ScreenW * self.childViewControllers.count, 0);
...
- (void)clickTitleBtn:(UIButton *)btn
{
    ...
    [UIView animateWithDuration:0.25 animations:^{
        // 按钮点击的时候,下划线位移
        // 做下划线的滑动动画
        self.underLineView.width = btn.titleLabel.width + 10;
...
- (void)setUpUnderLine
{
    ...
    CGFloat underLineY = self.TitleScrollV.height - underLineH;
    ...
    self.underLineView.centerX = firstButton.centerX + self.titleBtnView.glx_x;
}
